...
{
    public class BtqnPublishersController : Controller
    {
        private readonly BtqnBookStoreContext _context;

        public BtqnPublishersController(BtqnBookStoreContext context)
        {
            _context = context;
        }
        ...
        // GET: BtqnPublishers/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: BtqnPublishers/Create
